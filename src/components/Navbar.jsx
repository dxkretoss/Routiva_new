          ...
          <div className="hidden md:flex items-center gap-2.5 shrink-0">
            {isAuthenticated ? (
              <div className="flex items-center gap-2.5">
                <Link
                  to="/dashboard"
                  className="px-4 py-2 text-xs xl:text-sm font-bold text-primary-foreground bg-primary hover:bg-primary-hover rounded-xl shadow-glow transition-all flex items-center gap-1.5 whitespace-nowrap"
                >
